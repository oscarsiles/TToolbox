...
namespace CustomFileIO
{
    [Serializable()]
    public class CustomStreamReader : TextReader
    {
        public new static readonly CustomStreamReader Null = new NullmyStreamReader();
        ...
        public CustomStreamReader(Stream stream, bool detectEncodingFromByteOrderMarks)
        ...
        public CustomStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks)
            : this(stream, encoding, detectEncodingFromByteOrderMarks, DefaultBufferSize)
        {
        }

        public CustomStreamReader(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
        {
        ...
        public CustomStreamReader(String path)
        ...
        public CustomStreamReader(String path, bool detectEncodingFromByteOrderMarks)
        ...
        public CustomStreamReader(String path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
            : this(path, encoding, detectEncodingFromByteOrderMarks, DefaultBufferSize)
        {
        }

        /// <include file='doc\myStreamReader.uex' path='docs/doc[@for="myStreamReader.myStreamReader7"]/*' />
        public CustomStreamReader(String path, Encoding encoding, bool detectEncodingFromByteOrderMarks, int bufferSize)
        {
        ...
        public override String ReadLine()
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (ch == '\r' || ch == '\n')
                    {
                        ...
                        if (sb != null)
                        {
                            ...
                            _lineLength = _lineLength + t_encoder.GetByteCount(charBuffer, charPos, i - charPos, true);
                            s = sb.ToString();
                        }
                        else
                        {
                        ...
                        _lineLength = _lineLength + EolChars * linefeed_length;
                ...
                _lineLength = _lineLength + t_encoder.GetByteCount(charBuffer, charPos, i, true);
            } while (ReadBuffer() > 0);
        ...
        public String ReadLineAfterSeek(long offset_f)
        {
            stream.Seek(offset_f, 0);
            _lineLength = 0;
            //if (stream == null)
            //  __Error.ReaderClosed();
            //if(charPos == charLen)
        ...
        private class NullmyStreamReader : CustomStreamReader
        {
